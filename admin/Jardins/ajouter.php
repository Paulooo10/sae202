...
include '../../header.php';
?>
<h1 class="mt-6 text-2xl font-bold text-black sm:text-3xl md:text-4xl pl-20 pt-10">Ajouter un jardin en tant qu'admin:</h1>
  ...
  <div class="space-y-12">
    ...
    <h2 class="text-base font-semibold leading-7 text-gray-900">Informations générales</h2>
      ...
      <div class="sm:col-span-3 ">
          <label for="id_admin" class="block text-sm font-medium leading-6 text-gray-900">Auteur de l'annonce et proprietaire du jardin</label>
          <div class="mt-2">
            <select id="id_admin" name="id_admin" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset pl-3 ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-lime-600 sm:max-w-xs sm:text-sm sm:leading-6">
            <?php
    ...
    <input type="text" name="parcelles" id="parcelles" class="block w-full rounded-md border-0 py-1.5 pl-3 pr-20 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-lime-600 sm:text-sm sm:leading-6" placeholder="10">
        ...
        <fieldset>
          ...
          <div class="relative flex gap-x-3 mt-5">
              <div class="flex h-6 items-center">
                <input id="plantes" name="plantes" type="checkbox" value="1" class="h-4 w-4 rounded border-gray-300 text-lime-600 focus:ring-lime-600">
              </div>
              <div class="text-sm leading-6">
                <label for="plantes" class="font-medium text-gray-900">Partage de plantes</label>
                <p class="text-gray-500">Vous souhaitez que les locataires partagent les plantes entre eux.</p>
              </div>
            </div>
            <div class="relative flex gap-x-3 mt-5">
              <div class="flex h-6 items-center">
